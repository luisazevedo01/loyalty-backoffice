  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`absolute inset-0 transition-[opacity] delay-100 duration-700 ${navOpened ? 'h-svh opacity-90' : 'h-0 opacity-0'} w-full bg-black md:hidden`}
      />
      ...
      <Layout>
        ...
        <LayoutHeader className='sticky top-0 justify-between px-4 py-3 shadow md:px-4'>
          <div className={`flex items-center ${!isCollapsed ? 'gap-2' : ''}`}>
            ...
            >
              <span className='font-medium'>Loyalty App</span>
