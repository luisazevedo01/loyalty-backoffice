  ...
  ({ className, fadedBelow = false, fixedHeight = false, ...props }, ref) => (
    <div
      ...
      className={cn(
        ...
        fadedBelow &&
          'after:pointer-events-none after:absolute after:bottom-0 after:left-0 after:hidden after:h-32 after:w-full after:md:block',
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'flex h-[var(--header-height)] flex-none items-center gap-4 p-4 md:px-8',
      className
    )}
    {...props}
  />
