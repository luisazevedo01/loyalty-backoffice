...
interface CreateEmployeeFormProps {
  data: unknown
  createEmployee?: (data: z.infer<typeof companyFormSchema>) => Promise<void>
}

type EmployeeFormValues = z.infer<typeof companyFormSchema>

export default function CreateEmployeeForm(props: CreateEmployeeFormProps) {
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                This is your employee public display name.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea
                  placeholder='Any information that may be important about your employee.'
